...
namespace Robot
{
    ...
    public static class CMD
    {
        ...
        /// </summary>
        public static void SpeedL(Vector3 dir, Vector3 rotDir, float acceleration = 10.4f, float time = .05f)
        {
        ...
        /// </summary>
        public static void MoveJ(Pose pos, float acceleration = 1.4f, float speed = .5f, float time = 0, float radius = 0)
        {
        ...
        {
            ConnectionSend.Send("rq_activate_and_wait()\n" +
                                "rq_move_and_wait(58)\n");
        }
