...
namespace Robot
{
    public class Connection : MonoBehaviour
    {
        ...
        internal static uint tcpConnectionBytesRecieved;

        [SerializeField] TextAsset gripperFile;
        ...
        public static async Task Connect(string host = "127.0.0.1", int port = 30003)
        {
            ...
            OnConnected?.Invoke();
            Announcement.Announce("Connected");
        }
        ...
        public static void Disconnect()
        {
            ...
            Announcement.Announce("Disconnected");
        }

        private void OnEnable()
        {
            Data.Current = ScriptableObject.CreateInstance<Data>();
            //ConnectionSend.Send(gripperFile.text);
        }
