...
namespace Robot
{
    ...
    {
        public TMP_Text unityState, roboModes, roboSafety, tcpBytes;
        public Image unityStateImage, roboModeImage, roboSafetyImage, tcpBytesImage;
        [Space]
        ...
        private void Update()
        {
            ...
            tcpBytes.text = Connection.tcpConnectionBytesRecieved.ToString();
            ...
            switch (Connection.tcpConnectionBytesRecieved)
            {
                case 0: tcpBytesImage.color = bad; break;
                case ConnectionRecieve.totalMsgLenght: tcpBytesImage.color = good; break;
                default: tcpBytesImage.color = ok; break;
            }
        }
    }
}
