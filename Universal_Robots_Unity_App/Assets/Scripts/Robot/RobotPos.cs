...
namespace Robot
{
    ...
    public class RobotPos : ScriptableObject
    {
        public static RobotPos Current;
        ...
        public static RobotPos Home
        {
            get
            {
                RobotPos data = ScriptableObject.CreateInstance<RobotPos>();
